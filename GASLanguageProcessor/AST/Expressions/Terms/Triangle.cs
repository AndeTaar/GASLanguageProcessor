...
public class Triangle : Term
{
    ...
    public Triangle(Expression trianglePeak, Expression triangleBase, Expression stroke, Expression? color, Expression? strokeColor)
    {
    ...
    {
        return visitor.VisitTriangle(this, scope);
    }
}