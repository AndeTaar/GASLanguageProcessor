...
public partial class GASBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IGASVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitFunctionCallStatement([NotNull] GASParser.FunctionCallStatementContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitFunctionCallTerm([NotNull] GASParser.FunctionCallTermContext context) { return VisitChildren(context); }
}
