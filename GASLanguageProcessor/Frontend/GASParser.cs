...
public partial class GASParser : Parser {
	...
	public ProgramContext program() {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 9007207844477056L) != 0)) {
				{
				{
				State = 57;
				statement();
	...
	public FunctionDeclarationContext functionDeclaration() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8589705216L) != 0)) {
				{
				State = 184;
				type();
				State = 185;
	...
	public CollectionDeclarationContext collectionDeclaration() {
		...
		try {
			...
			if (_la==T__7) {
				...
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 66306048713031940L) != 0)) {
					{
					State = 223;
					expression();
					State = 228;
	...
	public GroupTermContext groupTerm() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 9007207844477056L) != 0)) {
				{
				State = 346;
				statement();
				State = 351;
	...
	private static int[] _serializedATN = {
		4,1,56,374,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,7,
		...
		2,0,15,15,18,32,1,0,33,34,1,0,35,36,2,0,16,17,37,38,1,0,39,40,1,0,41,43,
		2,0,40,40,44,44,399,0,56,1,0,0,0,2,63,1,0,0,0,4,77,1,0,0,0,6,84,1,0,0,
		...
		0,94,92,1,0,0,0,94,93,1,0,0,0,95,9,1,0,0,0,96,97,3,30,15,0,97,100,5,53,
		0,0,98,99,5,6,0,0,99,101,3,32,16,0,100,98,1,0,0,0,100,101,1,0,0,0,101,
		11,1,0,0,0,102,103,5,53,0,0,103,104,5,6,0,0,104,105,3,32,16,0,105,13,1,
		...
		3,32,16,0,169,23,1,0,0,0,170,171,5,14,0,0,171,172,5,53,0,0,172,176,5,8,
		...
		0,0,181,182,3,30,15,0,182,183,5,53,0,0,183,195,5,2,0,0,184,185,3,30,15,
		0,185,192,5,53,0,0,186,187,5,3,0,0,187,188,3,30,15,0,188,189,5,53,0,0,
		...
		208,209,5,16,0,0,209,210,3,30,15,0,210,211,5,17,0,0,211,212,5,53,0,0,212,
		...
		5,45,0,0,290,291,3,32,16,0,291,292,5,46,0,0,292,294,1,0,0,0,293,289,1,
		0,0,0,293,294,1,0,0,0,294,45,1,0,0,0,295,310,5,53,0,0,296,310,5,54,0,0,
		297,310,5,47,0,0,298,310,5,48,0,0,299,310,5,49,0,0,300,301,5,2,0,0,301,
		302,3,32,16,0,302,303,5,4,0,0,303,310,1,0,0,0,304,310,3,50,25,0,305,310,
		3,54,27,0,306,310,5,55,0,0,307,310,3,48,24,0,308,310,3,52,26,0,309,295,
		...
		307,1,0,0,0,309,308,1,0,0,0,310,47,1,0,0,0,311,312,5,53,0,0,312,313,5,
		50,0,0,313,326,5,53,0,0,314,323,5,2,0,0,315,320,3,32,16,0,316,317,5,3,
		...
		0,338,339,1,0,0,0,339,340,5,9,0,0,340,51,1,0,0,0,341,342,5,51,0,0,342,
		...
		4,0,0,358,53,1,0,0,0,359,360,5,53,0,0,360,369,5,2,0,0,361,366,3,32,16,
