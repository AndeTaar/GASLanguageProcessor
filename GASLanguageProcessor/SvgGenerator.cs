   ...
   public void GenerateLine(Object obj, Variable? variable = null)
   {
    switch (obj)
    {
        ...
        case FinalArrow arrow:
            ...
            SvgLines.Add($"<polygon id=\"{variable?.Identifier}\" points=\"{arrow.ArrowHead.AsPolygon.Points.ToString()}\" fill=\"{arrow.ArrowHead.Color.ColorToString()}\" fill-opacity=\"{arrow.ArrowHead.Color.Alpha}\" stroke=\"{arrow.ArrowHead.StrokeColor.ColorToString()}\" stroke-width=\"{arrow.ArrowHead.Stroke}\" />");
            break;
