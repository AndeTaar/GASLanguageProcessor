...
public class GenerateLineTests
{
    ...
    public void GenerateLineCanvasPass()
    {
        ...
        Assert.Equal("<svg width=\"500\" height=\"500\"" +
                     " style=\"background-colors: rgb(255, 255, 255)\"" +
    ...
    public void GenerateLineCirclePass()
    {
        var svgLines = SharedTesting.GetSvgLines(
            "canvas (250 * 2, 10 * 50, Colors(255, 255, 255, 1));" +
            "circle c = Circle(Point(10, 20), 30, 10, Colors(255, 0, 0, 1), Colors(0, 255, 0, 1));"
        );
    ...
    public void GenerateLineSegLinePass()
    {
        var svgLines = SharedTesting.GetSvgLines(
            "canvas (250 * 2, 10 * 50, Colors(255, 255, 255, 1));" +
            "segLine sl = SegLine(Point(10, 20), Point(30, 40), 10, Colors(255, 0, 0, 1));"
        );
    ...
    public void GenerateLineLinePass()
    {
        ...
        var svgLines = SharedTesting.GetSvgLines(
            $"canvas ({canvasWidth}, {canvasHeight}, Colors(255, 255, 255, 1));" +
            $"line l = Line({lineIntercept}, {lineGradient}, 10, Colors(255, 0, 0, 1));"
        );
    ...
    public void GenerateLineRectanglePass()
    {
        var svgLines = SharedTesting.GetSvgLines(
            "canvas (250 * 2, 10 * 50, Colors(255, 255, 255, 1));" +
            "rectangle r = Rectangle(Point(10, 20), Point(100, 250), 10, Colors(255, 0, 0, 1), Colors(0, 255, 0, 1),1);"
        );
    ...
    public void GenerateLineEllipsePass()
    {
        var svgLines = SharedTesting.GetSvgLines(
            "canvas (250 * 2, 10 * 50, Colors(255, 255, 255, 1));" +
            "ellipse e = Ellipse(Point(10, 20), 30, 40, 10, Colors(255, 0, 0, 1), Colors(0, 255, 0, 1));"
        );
    ...
    public void GenerateLineTextPass()
    {
        var svgLines = SharedTesting.GetSvgLines(
            "canvas (250 * 2, 10 * 50, Colors(255, 255, 255, 1));" +
            "text t = Text(\"Hello, World!\", Point(10, 20), \"Arial\", 20, 400, Colors(255, 0, 0, 1));"
        );
    ...
    public void GenerateLineSquarePass()
    {
        var svgLines = SharedTesting.GetSvgLines(
            "canvas (250 * 2, 10 * 50, Colors(255, 255, 255, 1));" +
            "square s = Square(Point(10, 20), 30, 10, Colors(255, 0, 0, 1), Colors(0, 255, 0, 1),1);"
        );
    ...
    public void GenerateLineGroupPass()
    {
        var svgLines = SharedTesting.GetSvgLines(
            ...
            "{" +
            "   circle groupCircle = Circle(Point(10, 20), 30, 10, Colors(255, 0, 0, 1), Colors(0, 255, 0, 1));" +
            "   square groupSquare = Square(Point(10, 20), 30, 10, Colors(255, 0, 0, 1), Colors(0, 255, 0, 1),1);" +
            "});"
        );
    ...
    public void GenerateLineListPass()
    {
        var svgLines = SharedTesting.GetSvgLines(
            ...
            "   Circle(Point(100, 200), 30, 10, Colors(0, 255, 0, 1), Colors(0, 0, 255, 1))" +
            "};"
        );
