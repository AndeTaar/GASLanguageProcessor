...
public class EvaluateExpressionUnaryOp
{
    ...
    {
        var scope = SharedTesting.GetInterpretedScope("canvas (-125, -50, Color(255, 255, 255, 1));number x = 20; number y = -x");
    ...
    {
        var scope = SharedTesting.GetInterpretedScope("canvas (125, 50, Color(255, 255, 255, 1)); bool x = !true");
